	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Registro <b>Hectareas </b></h2>
                    </div>
                </div>
				<div class="row">
                    <div class="col">
                        <input type="number" class="form-control" placeholder="Hectareas" id="cse_hec_hectareas">
                    </div>
		...
		<div class="modal-content">
			<form>
				<div class="modal-header">
					<h4 class="modal-title">Registro Hectareas</h4>
				...
				<div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Estado</label>
                        <select class="form-control" id="cmb_estado_form" required >
...
<script src="../js/jquery-3.5.1.min.js"></script>
    <script>
        ...
        $(document).ready(function() {
			...
			let titulo_error = 'Error, Registro Hectareas';
			let titulo_succes = 'Éxito, Registro Hectareas';
			let titulo_aviso = 'Aviso, Registro Hectareas';
			let titulo_advertencia = 'Advertencia , Registro Hectareas';
            ...
            function cargarcombo(){
				...
				$.ajax({
					type:"post",
					url: "Cosecha_Empaque/Hectarea_Controlador.php",
            ...
            function cargarUsuarios() {
                var cse_hec_hectareas = $("#cse_hec_hectareas").val();
                var buscar = 'buscar';
                $.ajax({
                    url: "Cosecha_Empaque/Hectarea_Controlador.php",
                    method: "POST",
                    data: { cse_hec_hectareas: cse_hec_hectareas,buscar:buscar},
           ...
           /*  $('#addEmployeeModal').on('hidden.bs.modal', function () {
			...
			$(document).on("click", ".edit", function() {
                ...
                var idlote = $userRow.find("td:eq(1)").text(); // Codigo Proveedor
				var hectareas = $userRow.find("td:eq(3)").text(); // Cantidad
                var estadoval = $userRow.find("td:eq(5)").text(); // Fecha
                
				// Llena los campos del modal con los valores obtenidos
				$("#txt_id").val(id);
				$("#cmb_lote_form").val(idlote);
                $("#txt_hectareas").val(hectareas);
			...
			$("#btn_ingreso").click(function(){
                ...
                var hectareas = $("#txt_hectareas").val();
				...
				if(!validarNumeroDecimal(hectareas) || parseFloat(hectareas) < 0 ){
					mensaje(titulo_error, 'Las hectareas debe ser positivo', 'error');
					return;
				}
                ...
                $.ajax({ 
                    ...
                    data:   {   accion:accion,
                                cse_hec_codigo: id,
                                cse_lot_codigo:lote,
                                cse_hec_hectareas:hectareas,
                                cse_hec_estado:estadoval
                            },
                    success:function(datos){
                        cargarUsuarios();
                        if(datos === '1'){
