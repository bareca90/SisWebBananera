	...
	<div class="table-responsive">
		<div class="table-wrapper">
			<div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h2>Cosecha / Lavado & Desinfeccion </b></h2>
                    </div>
                </div>
				<div class="row">
                    <div class="col-sm-3">
		...
		<div class="modal-content">
			<form>
				<div class="modal-header">
					<h4 class="modal-title">Cosecha / Lavado && Desinfeccion</h4>
...
<script src="../js/jquery-3.5.1.min.js"></script>
    <script>
        ...
        $(document).ready(function() {
            ...
            cargarcombo();
            cargarcombocosecha();
            let titulo_error = 'Error, Cosecha/Lavado y Desinfeccion';
			let titulo_succes = 'Éxito, Cosecha/Lavado y Desinfeccion';
			let titulo_aviso = 'Aviso, Cosecha/Lavado y Desinfeccion';
			let titulo_advertencia = 'Advertencia , Cosecha/Lavado y Desinfeccion';
			...
			$(document).on("click", ".edit", function() {
                ...
                var prodcod = $userRow.find("td:eq(1)").text(); // Codigo Proveedor
                var cantidad = $userRow.find("td:eq(3)").text();
                var coscod= $userRow.find("td:eq(4)").text();
                var fecha = $userRow.find("td:eq(6)").text(); // Codigo Proveedor
                var responsable = $userRow.find("td:eq(7)").text(); // Codigo Proveedor
                var estado = $userRow.find("td:eq(9)").text(); // Codigo Proveedor    
			...
			$(document).on("click", ".search", function() {
				...
				// Obtén los valores de las celdas de la fila
				var id = $userRow.find("td:eq(0)").text(); // ID
                var cantidad = $userRow.find("td:eq(3)").text(); // Cantidad
                var codproducto = $userRow.find("td:eq(2)").text(); // Cantidad
                var estadoval = $userRow.find("td:eq(9)").text(); // Estado
			...
			$("#btn_ingreso").click(function(){
                ...
                $.ajax({ 
                    ...
                    data:   {   accion:accion,
                                ...
                                cse_des_fecha_lavado:fecha,
                                cse_des_responsable:responsable,
                                cse_des_estado:estado
                            },
                    success:function(datos){
                        cargarUsuarios();
                        if(datos === '1'){
