<?php
    ...
    class PDF extends FPDF
    {
        ...
        function Header()
        {
            ...
            $this->setXY(60, 15);
            $this->Cell(80, 8, 'Informe Cajas Transportadas', 0, 1, 'C', 0);
            $this->Ln(10);
        }
    ...
    $pdf->Cell(90, 8, 'Motivo', 'B', 0, 'C', 0);
    $pdf->Cell(50, 8, 'Cajas Transportadas', 'B', 0, 'C', 0);
    ...
    $sql = "SELECT 	gre_gre_fecha_emision,
            ...
            WHERE gre_gre_fecha_emision = '$fechainicio'";
    ...
    while ($row = $result->fetch_assoc()) {
        $pdf->Ln(0.6);
        $pdf->setX(15);
        $pdf->Cell(25, 8, $row['gre_gre_fecha_emision'], 'B', 0, 'C', 1);
        $pdf->Cell(90, 8, $row['gre_gre_motivo_traslado'], 'B', 0, 'C', 1);
        $pdf->Cell(50, 8, $row['gre_gre_cat_cajas_transportadas'], 'B', 0, 'C', 1);
