<?php
    ...
    {       $this->cadena = $cadena;
        ...
        function Header()
        {
            ...
            $this->Cell(0, 2, 'Informe Fruta Primera', 0, 1, 'C', 0);
            $this->Ln(9);
            $this->SetFont('Helvetica', 'B', 16);
            $this->Cell(90, 3, 'Resumen Fruta Primera - ' . $this->cadena, 0, 1, 'L', 0);
            $this->Ln(5);
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $pdf->Cell(50, 8, $row['evc_evc_fruta_primera'], 'B', 0, 'C', 1);
