<?php
    ...
    {       $this->cadena = $cadena;
        ...
        function Header()
        {
            ...
            $this->Cell(0, 2, 'Informe Inventario Bodegas', 0, 1, 'C', 0);
            $this->Ln(9);
            $this->SetFont('Helvetica', 'B', 16);
            $this->Cell(90, 3, 'Resumen Bodegas ' . $this->cadena, 0, 1, 'L', 0);
            $this->Ln(5);
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $pdf->Cell(50, 8, $row['cse_cse_num_manos_rechazadas'], 'B', 0, 'C', 1);
