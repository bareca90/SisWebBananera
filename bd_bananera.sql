...
CREATE TABLE IF NOT EXISTS `seg_accesos_cab` (
  ...
  KEY `fk_seg_accesos_cab_seg_per_usu_empresa1_idx` (`seg_usu_codigo`,`seg_per_codigo`,`seg_emp_codigo`),
  CONSTRAINT `fk_seg_accesos_cab_seg_per_usu_empresa1` FOREIGN KEY (`seg_usu_codigo`, `seg_per_codigo`, `seg_emp_codigo`) REFERENCES `seg_per_usu_empresa` (`seg_usu_codigo`, `seg_per_codigo`, `seg_emp_codigo`),
...
CREATE TABLE IF NOT EXISTS `seg_perfil` (
  ...
  `seg_per_usu_modificacion` datetime DEFAULT NULL,
...
-- Volcando estructura para tabla db_bananera.seg_per_usu_empresa
CREATE TABLE IF NOT EXISTS `seg_per_usu_empresa` (
  `seg_usu_codigo` int NOT NULL,
  `seg_per_codigo` int NOT NULL,
  `seg_emp_codigo` int NOT NULL,
  PRIMARY KEY (`seg_usu_codigo`,`seg_per_codigo`,`seg_emp_codigo`),
  KEY `fk_seg_per_usu_empresa_seg_perfil1_idx` (`seg_per_codigo`),
  KEY `fk_seg_per_usu_empresa_seg_empresa1_idx` (`seg_emp_codigo`),
  CONSTRAINT `fk_seg_per_usu_empresa_seg_empresa1` FOREIGN KEY (`seg_emp_codigo`) REFERENCES `seg_empresa` (`seg_emp_codigo`),
  CONSTRAINT `fk_seg_per_usu_empresa_seg_perfil1` FOREIGN KEY (`seg_per_codigo`) REFERENCES `seg_perfil` (`seg_per_codigo`),
  CONSTRAINT `fk_seg_per_usu_empresa_seg_usuario1` FOREIGN KEY (`seg_usu_codigo`) REFERENCES `seg_usuario` (`seg_usu_codigo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;

-- Volcando datos para la tabla db_bananera.seg_per_usu_empresa: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `seg_per_usu_empresa` DISABLE KEYS */;
/*!40000 ALTER TABLE `seg_per_usu_empresa` ENABLE KEYS */;
...
-- Volcando datos para la tabla db_bananera.seg_rol: ~0 rows (aproximadamente)
...
INSERT INTO `seg_usuario` (`seg_usu_codigo`, `seg_usu_nombres`, `seg_usu_usuario`, `seg_usu_clave`, `seg_usu_estado`) VALUES
	...
	(13, 'Edgardo Bauza', 'ebauza', '123456', 'A');
